    ...
    <div class="card-header header-elements-md-inline shadow-sm mb-3">
        ...
        <div class="card-elements">
            <button type="button" class="btn btn-primary btn-sm" style="width: 100px;" data-toggle="modal"
                data-target="#form" wire:click="storePartner()">Tambah +</button>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="#" class="form-horizontal">
                    <input type="hidden" wire:model="partnerId">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select wire:model="role" class="form-control @error('role') is-invalid @enderror">
                                    <option>Pilih Tipe Mitra</option>
                                    <option value="customer">Pelanggan</option>
                                    <option value="farmer">Petani</option>
                                    <option value="operator">Pengurus</option>
                                </select>
