    ...
    <div class="mx-2">
        @if (session()->has('bran'))
            <div class="alert alert-success border-0 alert-dismissible">
                ...
                <span class="font-weight-semibold">{{ session()->get('bran') }} </span>
            </div>
        @endif
    </div>
    <div class="card mx-2">
        ...
        <div class="card-header header-elements-md-inline shadow-sm mb-3">
            <div class="card-title" style="margin-right: 50%">
                <h5 class="card-title">Data Dedak</h5>
            </div>
        </div>
            ...
            <div class="row mb-1 px-3">
                <div class="col-md-3">
                    <div class="card p-3 shadow-lg">
                        <span>Stok Dedak:</span>
                        <h3> {{ number_format($bran->stock) }} Kg</h3>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card p-3 shadow-lg">
                        <span>Harga PerKg:</span>
                        <h3>Rp. {{ number_format($bran->price,2,',','.')}}</h3>
                    </div>
                </div>
                <div class="col-md-6">
